    ...
    return (
      <React.Fragment>
        {{
         ...
         1: (<React.Fragment><b>{amount} Remme tokens</b> have been sent.<br/>It will be credited to your <a href={"https://ropsten.etherscan.io/address/" + tx} target="_blank" rel="noopener noreferrer">address</a> within an hour.</React.Fragment>)
        }[type]}
      </React.Fragment>
    )
  }
